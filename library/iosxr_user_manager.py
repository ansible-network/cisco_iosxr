...
DOCUMENTATION = '''
---
module: iosxr_user_manager
short_description: Manage an aggregate of users in Cisco IOSXR device(s)
description:
    - Allows the `cisco_iosxr` provider role to manage aggregate of users
...
options:
  new_users:
    description:
      - Aggregate of local users to be configured on iosxr device(s)
    required: true
  user_config:
    description:
